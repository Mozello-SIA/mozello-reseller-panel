var ResApi = function(properties) {
   ...
   var baseUrl = 'http://resellers.mozello.com/';
   ...
   var ResellersApi = {
      ...
      enablePremiumForWebsite: function (id, callback) {
         this.apiCall('api/website/' + id + '/enable_premium/', GetDefaultApiCallParams(), callback);
      },
