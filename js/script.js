...
function fillInWebsiteInspector(website) {
   ...
   $('#add-domain-name').val('');
   if (website.websiteIsPremium) {
      $('#website-inspector-premium-enabled').html('Enabled');
      ...
      $('#website-inspector-premium-enable-btn').html('Enable');
      $('#website-inspector-premium-enable-btn').off('click').on('click', function() {
         RA.enablePremiumForWebsite(websiteID, function(data) {
            reloadWebsiteInspector(websiteID);
         });
         return false;
      });
...
$(document).ready(function() {
   ...
   $('#menu a.integration').click(function() {
      ...
      RA.getSettings(function(settings) {
         ...
         var s_signup = 'http://' + s_domain + '/en/session/signup/params/reseller/' + s_reseller + '/';
         var s_login = 'http://' + s_domain + '/en/session/login/params/reseller/' + s_reseller + '/';
         ...
         if (settings['website']!='') {
            $('a#integration-website-url').attr('href', settings['website']).html(settings['website']);
         ...
         if (settings['domain']!='') {
            var s_dns = 'Add a wildcard CNAME type record <b>*.' + settings['domain'] + '</b> that points to <b>a.mozello.com</b>';
